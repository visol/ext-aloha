...
define(
['aloha/plugin', 'aloha/pluginmanager', 'aloha/floatingmenu', 'i18n!table/nls/i18n', 'i18n!aloha/nls/i18n', 'css!table/css/table.css'],
function(Plugin, PluginManager, FloatingMenu, i18n, i18nCore) {
	var
  ...
  */
  ...
  Table.prototype.selectRows = function () {
    ...
    for (var i = 0; i < this.rowsToSelect.length; i++) {
      ...
      TableHelper.selectedCells.push(rowCells);
